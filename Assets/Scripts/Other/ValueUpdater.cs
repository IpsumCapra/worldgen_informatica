...
public class ValueUpdater : MonoBehaviour
{
    ...
    public void UpdateNumbers()
    {
        ...
        InputField minNoiseHeight = GameObject.Find("Min Noise Height Input").GetComponent<InputField>();
        InputField maxNoiseHeight = GameObject.Find("Max Noise Height Input").GetComponent<InputField>();
        ...
        minNoiseHeight.text = generator.minNoiseHeight.ToString();
        maxNoiseHeight.text = generator.maxNoiseHeight.ToString();
